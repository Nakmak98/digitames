$(function() {
   $('.select2').select2({
        tags: true,
        "ajax": {
            url: " profile/admins/game_page_fetch.php",
            dataType: 'json',
            delay: 250,
            type: "POST",
    ...
    $('#select2').change( function () {
        ...
        $.ajax({
            url: " profile/admins/game_page_settings.php",
            type: 'POST',
	...
	$.post(" profile/admins/game_page_controller.php",
        data,
        function (data) {
        },
        "text"
    ...
    /*var table = $('#homePageData').DataTable({
        ...
        "scrollX": true,
        "ajax":{
            url:" profile/admins/home_page_fetch.php",
            type:"POST"
        }
    });*/
    $("#v-pills-profile").load(" profile/admins/account_setting.php", {profile_tab: "1"});

    //$("#v-pills-game-settings").load(" profile/admins/game_page_settings.php",{game_page_tab: "1"});

    //$("#v-pills-settings-home").load(" profile/admins/home_page_settings.php", {home_page_tab: "1"});
