    ...
    if(isset($_POST['new_password']) && isset($_POST['confirm_new_password'])) {
        if (strcmp($_POST['new_password'], $_POST['confirm_new_password'])) {
            ...
            if(isset($_POST['nickname'])) {
                $sql = "INSERT INTO user_data (nickname, age, region)
                      VALUES ('".$_POST['nickname']."','".$_POST['age']."' ,'".$_POST['region']."') WHERE user_id = '" . $_COOKIE['user_id'] . "'";
...
<br>
<h2 class="text-white">Hello <?php if(!isset($user_data['nickname'])) echo $_COOKIE['email']; else echo $user_data['nickname']; ?></h2>
<br>
    ...
    <div class="container text-white">
        <div class="row">
            ...
            <div class="col-sm-10">
                ...
                <form method="POST" action="/gamesite/templates/profile/php#v-pills-profile">
                    ...
                    <div class="form-row">
                        <div class="form-group col-sm-5">
                            ...
                            <input type="text" class="form-control" id="new_nickname" placeholder="nickname" name="nickname">
                            <br>
                            <label for="inputEmail4">Email:</label>
                            <input type="email" class="form-control" id="new_email" placeholder="Email" name="email" value="<?php echo $users['email']; ?>" >
                        </div>
                        ...
                        <div class="form-group col-sm-5">
                            ...
                            <input type="password" class="form-control" id="new_password" placeholder="Confirm Password" name="confirm_new_password" >
                        </div>
                    </div>
